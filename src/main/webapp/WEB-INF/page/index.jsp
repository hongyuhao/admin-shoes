...
<div id="header">
    <div class="headerNav">
        <ul class="nav">
			...
			<li><a href="http://www.shoes.com" target="_blank">商城首页</a></li>
        </ul>
    </div>
			...
			<div class="accordionContent">
				<ul class="tree treeFolder collapse">
					<li>
						...
						<ul>
							<li>
								<a href="/admin/brand?rel=brandHome"
								   target="navTab" rel="brandHome"
								   title="品牌管理">品牌管理</a>
							</li>
							<li>
	                			<a href="/admin/porder/?rel=porderHome"
	                					target="navTab" rel="porderHome"
	                					title="订单管理">订单管理</a>
	                		</li>
	                		<li>
	                			<a href="/admin/product?rel=productHome"
	                					target="navTab" rel="productHome"
	                					title="商品管理">商品管理</a>
	                		</li>
                            <li>
                                <a href="/admin/shoppingCart?rel=shoppingCartHome"
                                   target="navTab" rel="shoppingCartHome"
                                   title="购物车管理">购物车管理</a>
                            </li>
                            <li>
                                <a href="/admin/user?rel=userHome"
