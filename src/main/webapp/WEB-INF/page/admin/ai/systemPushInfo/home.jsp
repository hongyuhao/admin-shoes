...
<form id="pagerForm" method="post" action="/admin/ai/systemPushInfo">
...
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="/admin/ai/systemPushInfo" method="post">
	<input type="hidden" name="rel" value="${rel}"/>
	<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
	   <ul class="toolBar">
	      <li><a class="add" href="/admin/ai/systemPushInfo/edit" target="dialog" rel="editTag" mask="true" title="新增" width="620" height="500"><span>新增</span></a></li>
			<li><a class="delete" href="/admin/ai/systemPushInfo/softDel?rel=${rel}" target="selectedTodo" rel="inIdList" title="确定删除?"><span>删除</span></a></li>
	   </ul>
	</div>
...
<%-- 								<td><a title="修改" target="dialog" href="${path}/admin/ai/systemPushInfo/edit?id=${o.id}&rel=${rel}" rel="${rel}"  width="610" height="550"><span>修改</span></a>&nbsp;</td> --%>
							</tr>
						</c:forEach>
					</c:otherwise>
				</c:choose>
