...
<form id="pagerForm" method="post" action="/admin/stastic/redpackBpInDay/home?dataTypeId=1&rel=redpackBp&flag=1">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="/admin/stastic/redpackBpInDay/home?dataTypeId=1&rel=redpackBp&flag=1" method="post">
		<div class="searchBar">
