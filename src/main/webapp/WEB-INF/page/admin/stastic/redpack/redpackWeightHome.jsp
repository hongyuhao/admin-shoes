...
<form id="pagerForm" method="post" action="/admin/stastic/redpackWeightInDay/home?dataTypeId=3&rel=redpackWeight&flag=1">
...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="/admin/stastic/redpackWeightInDay/home?dataTypeId=3&rel=redpackWeight&flag=1" method="post">
		<div class="searchBar">
