...
<form id="pagerForm" method="post" action="/admin/stastic/user/unfollow/list?rel=unfollow&type=unfollow_users">
...
<div class="pageHeader">
	<tr>
		<td>
			总取消关注用户数: <span id ="sum${rel }"></span>
		</td>
	</tr>
	<form onsubmit="return navTabSearch(this);" action="/admin/stastic/user/unfollow/list?rel=unfollow&type=unfollow_users" method="post">
		<div class="searchBar">
			<table class="searchContent">
				<tr>
					<td>
						今日取消关注: <span id ="num${rel }"></span>
					</td>
					<td>
