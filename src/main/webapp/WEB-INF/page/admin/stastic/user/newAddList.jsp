...
<form id="pagerForm" method="post" action="/admin/stastic/user/new/add/list?rel=add&type=added_users">
...
<div class="pageHeader">
	...
	<form onsubmit="return navTabSearch(this);" action="/admin/stastic/user/new/add/list?rel=add&type=added_users" method="post">
		<div class="searchBar">
			<table class="searchContent">
				<tr>
					<td>
						今日新增用户: <span id ="num${rel }"></span>
					</td>
					<td>
