...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="${path }/admin/ucenter/taskInfo/editRelation.do?rel=${rel}&eqSubFlowId=${eqSubFlowId}" rel="${rel}" target="dialog" width="750" height="200"><span>新增关系</span></a></li>
			<li><a class="delete" href="${path}/admin/ucenter/taskInfo/deleteRelation.do?rel=${rel}"
