...
<form id="pagerForm" method="post" action="${path }/admin/permission/taskInfo">
...
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="${path }/admin/permission/taskInfo" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="${path }/admin/permission/taskInfo/edit.do?rel=${rel}" rel="${rel}" target="dialog" width="800" height="550"><span>添加</span></a></li>
			<li><a class="delete" href="${path }/admin/permission/taskInfo/delete.do?rel=${rel}" target="selectedTodo" rel="ids" title="只有未启用和过期的任务才能删除,确定删除?"><span>删除</span></a></li>
...
<%-- 									<c:if test="${object.actionType == actionList.actionType }"> --%>
										<c:if test="${object.status == 1 }">
											<a title="修改" target="dialog" href="${path}/admin/permission/taskInfo/edit?id=${object.id}&rel=${rel}" rel="${rel}"  width="800" height="550"><span>修改</span></a>&nbsp;
										</c:if>
<%-- 									</c:if> --%>
<%-- 								</c:forEach> --%>
