...
<script type="text/javascript">
	function resHandler(response) {
		...
		navTab.reload("${path}/admin/permission/taskInfo/listRelation.do?eqSubFlowId=${model.id}&rel=${rel}", "");
		$.pdialog.closeCurrent();
	}
</script>
<div class="pageContent">
	<form method="post" action="${path }/admin/permission/taskInfo/addRelation.json"
