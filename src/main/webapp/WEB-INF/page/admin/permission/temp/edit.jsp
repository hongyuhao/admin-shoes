...
<script type="text/javascript">
	...
	function processBack(response) {
		...
		navTab.reload("${path }/admin/taskInfo", "");
	}
</script>
<c:choose>
	<c:when test="${model.id==0 ||empty model.id}">
		<c:set var="action" value="${path }/admin/permission/taskInfo/add.do"></c:set>
	</c:when>
	<c:otherwise>
		<c:set var="action" value="${path }/admin/permission/taskInfo/update.do"></c:set>
	</c:otherwise>
</c:choose>
			...
			<dl>
				...
				<dd>
					...
					<input class="text" name="wxCardId" id="wxCardId" type="hidden" suggestFields="wxCardId"
						...
						href="/admin/taskInfo/promotionList?sendCardType=2&showType=2"
						lookupgroup="">查找带回</a>
				</dd>
			</dl>
			<dl>
				...
				<dd>
					...
					<input name="giveRedPacketName" id="giveRedPacketName" type="text"
						...
						lookupGroup="" readonly="true"/> <a class="btnLook"
						href="/admin/taskInfo/redPackList"
						lookupgroup="">查找带回</a>
				</dd>
			</dl>
			<dl>
