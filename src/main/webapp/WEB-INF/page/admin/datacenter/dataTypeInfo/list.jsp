...
<form id="pagerForm" method="post" action="/admin/datacenter/dataTypeInfo?isLookup=1">
...
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return dwzSearch(this, 'dialog');" action="/admin/datacenter/dataTypeInfo?isLookup=1" method="post">
	<div class="searchBar">
