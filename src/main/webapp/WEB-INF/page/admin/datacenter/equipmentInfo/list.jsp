...
<form id="pagerForm" method="post" action="/admin/datacenter/equipmentInfo?isLookup=1">
...
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return dwzSearch(this, 'dialog');" action="/admin/datacenter/equipmentInfo?isLookup=1" method="post">
	<div class="searchBar">
					...
					<c:otherwise>
						<c:forEach var="o" items="${equipmentInfoList}">
							<tr target="id" rel="${o.id}">
								...
								<td><a class="btnSelect" href="javascript:$.bringBack({equipmentId:'${o.id}',equipmentName:'${o.name}'})" title="查找带回">选择</a></td>
							</tr>
						</c:forEach>
					</c:otherwise>
				</c:choose>
