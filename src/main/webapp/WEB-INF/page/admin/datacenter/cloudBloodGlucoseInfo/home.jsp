...
<div class="pageHeader">
	<form rel="pagerForm" onsubmit="return navTabSearch(this);" action="/admin/datacenter/cloudBloodGlucoseInfo" method="post">
	<div class="searchBar">
...
<div class="pageContent">
	...
	<table class="list" width="100%" layoutH="100">
		...
		<tbody>
				<c:choose>
					<c:when test="${null==cloudBloodGlucoseInfoList||cloudBloodGlucoseInfoList.isEmpty()}">
						<tr class="tatr2">
							<td colspan="11" align="center">暂无数据</td>
						</tr>
					</c:when>
					<c:otherwise>
						<c:forEach var="o" items="${cloudBloodGlucoseInfoList}">
							<tr>
								<td>
									${o.equipmentSn}
								</td>
								<td>${o.bloodGlucose}</td>
